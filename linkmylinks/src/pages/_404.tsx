    ...
    <div className="container">
      <div className="row">
        <div className="col-sm-8 offset-sm-2 text-gray-50 text-center  p-6 -mt-52">
          ...
          <h5 className="text-gray-200 font-semibold -mr-10 -mt-3">
            Page not found
          </h5>
          <p className="text-gray-100 mt-2 mb-6">
            We are sorry, but the page you requested was not found
          </p>
          <Link to="/" className="bg-indigo-400 hover:bg-indigo-600  px-5 py-3 text-sm shadow-sm font-medium tracking-wider text-gray-50 rounded-full hover:shadow-lg">
            Got to Home
          </Link>
        </div>
      </div>
